...
var file_usermgmt_usermgmt_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x32, 0x44, 0x0a, 0x0d, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x6d,
	0x65, 0x6e, 0x74, 0x12, 0x33, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x4e, 0x65, 0x77, 0x55,
	...
	0x74, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x22, 0x00, 0x42, 0x20, 0x5a, 0x1e, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x6e, 0x69, 0x70, 0x65, 0x70, 0x2f, 0x75, 0x73,
	0x65, 0x72, 0x6d, 0x67, 0x6d, 0x74, 0x47, 0x52, 0x50, 0x43, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_usermgmt_usermgmt_proto_depIdxs = []int32{
	0, // 0: usermgmt.UserManagment.CreatNewUser:input_type -> usermgmt.NewUser
	1, // 1: usermgmt.UserManagment.CreatNewUser:output_type -> usermgmt.User
...
func file_usermgmt_usermgmt_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_usermgmt_usermgmt_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_usermgmt_usermgmt_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
